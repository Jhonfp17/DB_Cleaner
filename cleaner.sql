...
/* RETO 11  Genera un listado con el código de pedido, código de cliente, fecha esperada y fecha de entrega de los pedidos cuya fecha de entrega ha sido al menos dos días antes de la fecha esperada.
...
from pedido
where year (fecha_pedido) = 2009 and estado <> 'Entregado' and estado <> 'Pendiente';
...
select fecha_pedido,estado
from pedido
where  estado <> 'Pendiente' and estado <> 'Reachazado' and fecha_entrega  and MONTH (fecha_entrega) = 1;
...
from pago
where year(fecha_pago) = 2008 and forma_pago = 'PayPal' order by total desc;
